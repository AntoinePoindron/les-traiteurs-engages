...
export default function FilterTabs({ activeFilter, searchQuery }: FilterTabsProps) {
  ...
  return (
    <div className="bg-white rounded-lg p-6 flex items-center justify-between gap-4">
        ...
        {TABS.map((tab) => {
          ...
          return (
            <button
              ...
              className="px-3 py-2 rounded-full text-xs font-bold transition-colors whitespace-nowrap"
              style={{
      ...
      {/* Recherche */}
      <div
        className="flex items-center justify-between gap-2 px-3 py-2 rounded-lg border border-black shrink-0"
        style={{ width: "261px" }}
      >
        <input
          type="text"
